        ...
        <div className="about__container container grid">
          ...
          <div className="about__data">
            ...
            <p className="about__description">
              ...
              developer, specializing in Flutter. I completed an internship
              where I honed my skills in Flutter development. I am enthusiastic
              about exploring new technologies and contributing to innovative
              projects.
            </p>
            <a
              download=""
              ...
              style={{ backgroundColor: "#1AB9A7" }}
              onMouseEnter={(e) => {
                e.currentTarget.style.setProperty("background-color", "black");
              ...
              onMouseLeave={(e) =>
                e.currentTarget.style.setProperty("background-color", "#1AB9A7")
              }
            >
              Download Resume
              <svg
